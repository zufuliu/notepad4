...
EDITLEXER lexCmake = { SCLEX_CMAKE, 63046, L"CMake Script", L"cmake; ctest", L"", &KeyWords_CMAKE,
{
	...
	{ SCE_CMAKE_COMMANDS, 63327, L"Function", L"fore:#00007F", L"" },
	{ SCE_CMAKE_PARAMETERS, 63362, L"Parameter", L"fore:#7F200F", L"" },
	{ SCE_CMAKE_VARIABLE, 63326, L"Variable", L"fore:#CC3300", L"" },
	{ SCE_CMAKE_WHILEDEF, 63363, L"While def", L"fore:#00007F", L"" },
	{ SCE_CMAKE_FOREACHDEF, 63364, L"For each def", L"fore:#00007F", L"" },
	{ SCE_CMAKE_IFDEFINEDEF, 63365, L"If def", L"fore:#00007F", L"" },
	{ SCE_CMAKE_MACRODEF, 63366, L"Macro def", L"fore:#00007F", L"" },
	{ SCE_CMAKE_STRINGVAR, 63367, L"Variable within string", L"back:#EEEEEE; fore:#CC3300", L"" },
	{ SCE_CMAKE_NUMBER, 63130, L"Number", L"fore:#FF0000", L"" },
