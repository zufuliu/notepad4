...
static TBBUTTON tbbMainWnd[] = {
	...
	{26, 	IDT_FILE_EMPTYWINDOW, 	TBSTATE_ENABLED, TBSTYLE_BUTTON, {0}, 0, 0},
};
...
LRESULT MsgCommand(HWND hwnd, WPARAM wParam, LPARAM lParam) {
	...
	case IDT_FILE_EMPTYWINDOW:
	case IDM_FILE_RESTART: {
		const bool emptyWind = LOWORD(wParam) == IDM_FILE_NEWWINDOW2 || LOWORD(wParam) == IDT_FILE_EMPTYWINDOW;
