...
"and as base Break break Case case Catch catch class Contains contains Continue continue Critical critical "
"Default default Else else Exit exit ExitApp extends False false Finally finally For for get Global global Goto goto "
"If if in is isset Local local Loop loop new not OnError OnExit or Pause pause Reload reload Return return "
"set SetTimer Sleep sleep Static static super Suspend suspend Switch switch "
"this Thread thread Throw throw True true Try try unset Until until While while "
...
"PgDn PgUp PrintScreen RAlt RButton RControl RCtrl Right RShift RWin ScrollLock Shift Space Up "
