...
"Break Case Catch Contains Continue Critical Default Else Exit ExitApp False Finally For Global Goto If Local Loop "
"OnError OnExit Pause Reload Return SetTimer Sleep Static Suspend Switch Thread Throw True Try Until While and as "
"base break case catch class contains continue critical default else exit extends false finally for get global goto "
"if in is isset local loop new not or pause reload return set sleep static super suspend switch "
"this thread throw true try unset until while "
...
"CheckBox Class ClipboardAll Closure ComObjArray ComObject ComValue ComValueRef ComboBox Control Custom DDL DateTime "
"Edit Enumerator Error File Float Func GroupBox Gui Hotkey IndexError InputHook Integer KeyError "
"Link List ListBox ListView Map MemberError MemoryError Menu MenuBar MethodError MonthCal Number OSError Object "
...
"A_AhkPath A_AhkVersion A_AllowMainWindow A_AppData A_AppDataCommon A_Args A_Clipboard A_ComSpec A_ComputerName "
...
"A_MM A_MMM A_MMMM A_MSec A_MaxHotkeysPerInterval A_MenuMaskKey A_Min A_MouseDelay A_MouseDelayPlay A_MyDocuments "
...
"LAlt LButton LControl LCtrl LShift LWin Launch_App1 Launch_App2 Launch_Mail Launch_Media Left "
...
"PgDn PgUp PrintScreen RAlt RButton RControl RCtrl RShift RWin Right ScrollLock Shift Space Up "
"Volume_Down Volume_Mute Volume_Up WheelDown WheelLeft WheelRight WheelUp XButton1 XButton2 "

, // 6 functions
"ACos( ASin( ATan( Abs( Add( AddControlType( AddStandard( AttributeString Bind( BlockInput "
"Call( CallbackCreate( CaretGetPos( Ceil( Check( Choose( Chr( Clear( Click ClipWait ClipboardAll( Clone( Close( ComCall( "
"ComObjActive( ComObjArray( ComObjConnect ComObjFlags( ComObjFromPtr( ComObjGet( ComObjQuery( ComObjType( ComObjValue( "
"ComObject( ComValue( ControlAddItem ControlChooseIndex ControlChooseString ControlClick ControlDeleteItem "
...
"ImageSearch "
"InStr( IniDelete IniRead( IniWrite InputBox( InputHook( Insert( InsertAt( InstallKeybdHook InstallMouseHook Integer( "
...
"KeyHistory KeyWait LTrim( ListHotkeys ListLines ListVars ListViewGetContent( Ln( LoadPicture( Log( "
...
"RTrim( Random( RawRead( RawWrite( Read( ReadLine( ReadNumType( Redraw( "
"RegDelete RegDeleteKey RegExMatch( RegExReplace( RegRead( RegWrite RemoveAt( Rename( Restore( Round( Run RunAs RunWait( "
...
"StrCompare( StrGet( StrLen( StrLower( StrPtr( StrPut StrReplace( StrSplit( StrTitle( StrUpper( String( "
"SubStr( Submit( Suspend SysGet( SysGetIPAddresses( "
...
, // 7 misc
"AtEOF BackColor C Capacity CaseSense ClassNN ClickCount Com Comment Comments Count Enabled Encoding "
"Files Focused FocusedCtrl "
"HKCU HKEY_CLASSES_ROOT HKEY_CURRENT_CONFIG HKEY_CURRENT_USER HKEY_LOCAL_MACHINE HKEY_USERS HKLM Handle Hwnd "
"IsBuiltIn IsVariadic Join LTrim Len Length MarginX MarginY Mark MaxParams MinParams Name Parse Pos Ptr "
"REG_BINARY REG_DWORD REG_DWORD_BIG_ENDIAN REG_EXPAND_SZ REG_FULL_RESOURCE_DESCRIPTOR REG_LINK REG_MULTI_SZ REG_QWORD "
"REG_RESOURCE_LIST REG_RESOURCE_REQUIREMENTS_LIST REG_SZ RTrim Read Reg "
"Size Title Type Value Visible "
...
//Settings++Autogenerated -- start of section automatically generated
	{
		...
		| KeywordAttr32(3, KeywordAttr_MakeLower) // objects
		| KeywordAttr32(4, KeywordAttr_MakeLower) // built-in variables
		| KeywordAttr32(5, KeywordAttr_MakeLower) // keys
		| KeywordAttr32(6, KeywordAttr_MakeLower) // functions
		| KeywordAttr32(7, KeywordAttr_NoLexer) // misc
	},
