...
, // 5 values
"BL BR BT KK LB LR LT RB RL RT TB TL TR _graphviz avg_dist back bold both breadthfirst circuit clust curved "
"dashed diagonals dotted edgesfirst ediamond empty fast filled forward global graph_dist halfopen hier "
"invdot invempty invodot ipsep line local major max maxent mds min nodesfirst open ortho polyline power_dist "
"random rng rounded same self sgd shortpath sink solid source spline spring striped subset tapered wedged "
