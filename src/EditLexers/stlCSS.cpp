...
static const char * const Keywords_CSS[] = {
...
"background-position background-position-block background-position-inline background-position-x background-position-y "
"background-repeat background-repeat-block background-repeat-inline background-repeat-x background-repeat-y "
...
"bookmark-label bookmark-level bookmark-state border border-block border-block-clip border-block-color border-block-end "
"border-block-end-clip border-block-end-color border-block-end-radius border-block-end-style border-block-end-width "
"border-block-start border-block-start-clip border-block-start-color border-block-start-radius border-block-start-style "
"border-block-start-width border-block-style border-block-width border-bottom border-bottom-clip border-bottom-color "
"border-bottom-left-radius border-bottom-radius border-bottom-right-radius border-bottom-style border-bottom-width "
"border-boundary border-clip border-collapse border-color border-end-end-radius border-end-start-radius "
...
"border-inline-end-clip border-inline-end-color border-inline-end-radius border-inline-end-style border-inline-end-width "
"border-inline-start border-inline-start-clip border-inline-start-color border-inline-start-radius "
"border-inline-start-style border-inline-start-width border-inline-style border-inline-width "
"border-left border-left-clip border-left-color border-left-radius border-left-style border-left-width border-limit "
"border-radius "
"border-right border-right-clip border-right-color border-right-radius border-right-style border-right-width "
"border-shape border-spacing border-start-end-radius border-start-start-radius border-style border-top "
"border-top-clip border-top-color border-top-left-radius border-top-radius border-top-right-radius border-top-style "
"border-top-width border-width bottom box-decoration-break "
"box-shadow box-shadow-blur box-shadow-color box-shadow-offset box-shadow-position box-shadow-spread box-sizing box-snap "
...
"column-fill column-gap column-height column-rule column-rule-break column-rule-color "
"column-rule-edge-inset column-rule-edge-inset-end column-rule-edge-inset-start "
"column-rule-inset column-rule-inset-end column-rule-inset-start "
"column-rule-interior-inset column-rule-interior-inset-end column-rule-interior-inset-start column-rule-style "
"column-rule-visibility-items column-rule-width column-span column-width column-wrap columns components contain "
"contain-intrinsic-block-size contain-intrinsic-height contain-intrinsic-inline-size contain-intrinsic-size "
"contain-intrinsic-width container container-name container-type content content-visibility continue corner "
"corner-block-end corner-block-end-shape corner-block-start corner-block-start-shape corner-bottom "
"corner-bottom-left corner-bottom-left-shape corner-bottom-right corner-bottom-right-shape corner-bottom-shape "
"corner-end-end corner-end-end-shape corner-end-start corner-end-start-shape "
"corner-inline-end corner-inline-end-shape corner-inline-start corner-inline-start-shape corner-left corner-left-shape "
"corner-right corner-right-shape "
"corner-shape corner-start-end corner-start-end-shape corner-start-start corner-start-start-shape "
"corner-top corner-top-left corner-top-left-shape corner-top-right corner-top-right-shape corner-top-shape "
...
"float float-defer float-offset float-reference flood-color flood-opacity flow flow-from flow-into flow-tolerance font "
"font-display font-family font-feature-settings font-kerning font-language-override font-named-instance "
...
"item-cross item-direction item-flow item-pack item-track item-wrap "
...
"overflow-clip-margin-right overflow-clip-margin-top overflow-inline overflow-wrap overflow-x overflow-y overlay "
"override-colors "
...
"quotes "
"range reading-flow reading-order region-fragment rendering-intent resize resolution rest rest-after rest-before result "
"richness right rotate row-gap row-rule row-rule-break row-rule-color "
"row-rule-edge-inset row-rule-edge-inset-end row-rule-edge-inset-start "
"row-rule-inset row-rule-inset-end row-rule-inset-start "
"row-rule-interior-inset row-rule-interior-inset-end row-rule-interior-inset-start row-rule-style "
"row-rule-visibility-items row-rule-width ruby-align ruby-merge ruby-overhang ruby-position rule rule-break rule-color "
"rule-edge-inset rule-inset rule-inset-end rule-inset-start rule-interior-inset rule-overlap rule-style "
"rule-visibility-items rule-width running "
...
"scroll-timeline scroll-timeline-axis scroll-timeline-name scrollable scrollbar-color scrollbar-gutter scrollbar-width "
"scrolled "
"shape shape-image-threshold shape-inside shape-margin shape-outside shape-padding shape-rendering shape-subtract "
"size size-adjust slider-orientation snapped "
...
"in-range indeterminate interest-source interest-target invalid is( "
"lang( last-child last-of-type left link local-link low-value modal muted "
"not( nth-child( nth-col( nth-last-child( nth-last-col( nth-last-of-type( nth-of-type( "
"only-child only-of-type open optimal-value optional out-of-range "
"past paused picture-in-picture placeholder-shown playing popover-open read-only read-write recto required right root "
"scope scope-context( seeking snapped snapped-block snapped-inline snapped-x snapped-y stalled state( "
"target target-current target-within unchecked user-invalid user-valid valid verso visited volume-locked where( "

, // 3 pseudo elements
"^-moz- ^-ms- ^-o- ^-webkit- after backdrop before blank( checkmark clear-icon color-swatch column content "
"details-content "
"field-component field-separator field-text file-selector-button fill first-letter first-line "
"footnote-call footnote-marker "
"grammar-error highlight( marker nth-fragment( part( picker( picker-icon placeholder postfix prefix region "
"scroll-marker scroll-marker-group search-text selection shadow slot( spelling-error step-control step-down step-up "
"target-text thumb track "
...
"alternate alternate-reverse always "
"anchor( anchor-size( anchored( anchors-valid anchors-visible and annotation( anywhere append( "
"arcs argb( arguments armenian around as at at-rule( attr( "
"audio aural auto auto-areas auto-fill auto-fit auto-flow auto-phrase "
"average( avoid avoid-column avoid-flex avoid-line avoid-page avoid-region "
"back backwards balance balance-all bar baseline behind below between bevel bidi-override bitmap "
"blackness( blink block block-end block-start blue( blur( "
"bold bolder boolean( border-box both both-edges bottom-to-top bounding-box "
...
"column-over-row column-reverse common-ligatures compact compatible( complement( compress condensed conic-gradient( "
"constrained-high content( content-box content-exists( contents context-menu contextual continuous "
"contrast( contrast-color( control-value( convert( copy corners counter( counters( cover "
"create crisp-edges crispEdges crop cross cross-fade( crosshair css cubic-bezier( currentColor cursive custom cyclic "
...
"embed embed( embedded-opentype embossed emoji env( escape( evenodd ew-resize "
...
"font-format( font-tech( footnote force force-end force-hidden format( forwards fragments from from-font from-image "
...
"image( image-height( image-set( image-size( image-width( important in increment incremental index( inert "
"infinite infinity inherit inherit( initial initial-only "
"inline inline-block inline-end inline-flex inline-grid inline-masonry inline-start inline-table inner "
"insert insert( inset( inside inspect( int( inter-character inter-word interactive interlace intersect intersection "
...
"leader( leading left-side left-to-right leftwards legacy length( less level "
"light light-dark( lighten lighten( lighter lightness( "
...
"male mandatory manipulation manual map margin-box masonry "
...
"not not-allowed notch nowrap ns-resize nth( null numbers numeric numeric-only nw-resize nwse-resize "
...
"replace replace( returns reverse revert revert-layer rgb( rgba( ridge right-side right-to-left rightwards "
"rotate( rotate-left rotate-right rotate3d( rotateX( rotateY( rotateZ( round row row-over-column row-resize row-reverse "
"rtl ruby ruby-base ruby-base-container ruby-text ruby-text-container run-in running( "
"s-resize sRGB safe same sans-serif saturate( saturation saturation( scale( scale-down scale3d( scaleX( scaleY( scaleZ( "
"scoop screen screen( scroll scroll( scroll-position scroll-state scroll-state( se-resize searchfield "
"select( selector selector( self-end self-start semi-condensed semi-expanded separate separator( sepia( serif sesame "
"set( set-nth( shade( shape( show "
"sibling-count( sibling-index( sides sideways sideways-lr sideways-rl silent simple-selectors( simplified size( "
...
"to to-lower-case( to-upper-case( toggle( top-to-bottom "
...
static const EDITSTYLE Styles_CSS[] = {
	EDITSTYLE_DEFAULT,
...
//Settings--Autogenerated -- end of section automatically generated
	EDITLEXER_HOLE(L"CSS Style Sheet", Keywords_CSS, Styles_CSS),
