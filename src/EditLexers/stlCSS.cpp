...
"column-fill column-gap column-height "
"column-rule column-rule-break column-rule-color column-rule-outset column-rule-style column-rule-width column-span "
"column-width column-wrap columns components contain contain-intrinsic-block-size contain-intrinsic-height "
"contain-intrinsic-inline-size contain-intrinsic-size contain-intrinsic-width container container-name container-type "
"content content-visibility continue corner "
...
"inverted-colors isolation item-cross item-direction item-flow item-pack item-tolerance item-track item-wrap "
...
"richness right rotate row-gap row-rule row-rule-break row-rule-color row-rule-outset row-rule-style row-rule-width "
"ruby-align ruby-merge ruby-overhang ruby-position "
"rule rule-break rule-color rule-outset rule-paint-order rule-style rule-width running "
...
"has( high-value host host( host-context( hover in-range indeterminate invalid is( "
...
"past paused picture-in-picture placeholder-shown playing read-only read-write recto required right root "
...
"arcs argb( arguments armenian as at at-rule( attr( audio aural auto auto-areas auto-fill auto-fit auto-flow auto-phrase "
