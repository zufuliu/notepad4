...
EDITLEXER lexTcl = { SCLEX_TCL, NP2LEX_TCL, EDITLEXER_HOLE(L"Tcl Script"), L"tcl; itcl; tm", L"", &Keywords_Tcl,
{
	...
	{ MULTI_STYLE(SCE_TCL_WORD, SCE_TCL_WORD2, SCE_TCL_WORD3, SCE_TCL_WORD_IN_QUOTE), NP2STYLE_Keyword, L"Keyword", L"bold; fore:#FF8000", L"" },
	{ MULTI_STYLE(SCE_TCL_COMMENT, SCE_TCL_COMMENTLINE, SCE_TCL_COMMENT_BOX, SCE_TCL_BLOCK_COMMENT), NP2STYLE_Comment, L"Comment", L"fore:#608060", L"" },
	...
	{ MULTI_STYLE(SCE_TCL_SUBSTITUTION, SCE_TCL_SUB_BRACE, 0, 0), 63441, L"Substitution", L"fore:#0080FF", L"" },
