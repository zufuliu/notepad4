...
, // 1 type
"bfloat double float fp128 half i1 i128 i16 i32 i64 i8 label metadata opaque ppc_fp128 token type void vscale "
"x86_fp80 x86_mmx "

, // 2 attribute
"acq_rel acquire addrspace( afn align align( alignstack alignstack( allocsize( alwaysinline any anyregcc arcp argmemonly "
"atomic "
"blockaddress( builtin byval byval( ccc cfguard_checkcc cold coldcc contract convergent cxx_fast_tlscc "
"default denormal-fp-math denormal-fp-math-f32 dereferenceable( dereferenceable_or_null( dllexport dllimport "
"dso_local dso_local_equivalent dso_preemptable "
"exact exactmatch fast fastcc frame-pointer hidden hot "
...
"jumptable largest local_unnamed_addr localdynamic localexec minsize monotonic mustprogress "
"naked nest ninf nnan no-inline-line-tables no-jump-tables no-stack-arg-probe noalias nobuiltin nocapture nocf_check "
"noduplicate noduplicates nofree noimplicitfloat noinline nomerge nonlazybind nonnull norecurse noredzone noreturn "
"nosync noundef nounwind nsw nsz null-pointer-is-valid nuw "
"optforfuzzing optnone optsize patchable-function preallocated( preserve_allcc preserve_mostcc probe-stack protected "
...
"webkit_jscc willreturn writeonly zeroext zeroinitializer "
...
"eq extractelement extractvalue fadd fcmp fdiv fence filter fmul fneg fpext fptosi fptoui fptrunc freeze frem from fsub "
