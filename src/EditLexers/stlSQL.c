...
"name names national natural ndb ndbcluster nested never new next no nocase nodegroup nonblocking none not nothing notnull nowait no_wait no_write_to_binlog nth_value ntile null nullif nulls number "
...
static EDITSTYLE Styles_SQL[] = {
	...
	//{ SCE_SQL_IDENTIFIER, NP2STYLE_Identifier, EDITSTYLE_HOLE(L"Identifier"), L"fore:#800080" },
	//{ SCE_SQL_QUOTEDIDENTIFIER, , EDITSTYLE_HOLE(L"Quoted Identifier"), L"fore:#800080; back:#FFCCFF" },
	...
	{ SCE_SQL_VARIABLE, NP2STYLE_Variable, EDITSTYLE_HOLE(L"Variable"), L"fore:#CC3300" },
