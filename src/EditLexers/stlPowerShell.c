...
EDITLEXER lexPS1 = { SCLEX_POWERSHELL, NP2LEX_PS1, EDITLEXER_HOLE(L"PowerShell Script"), L"ps1; psc1; psd1; psm1", &Keywords_PS1,
{
	...
	{ MULTI_STYLE(SCE_POWERSHELL_CMDLET, SCE_POWERSHELL_FUNCTION, 0, 0), 63481, EDITSTYLE_HOLE(L"Cmdlet"), L"fore:#804000; back:#FFF1A8" },
	{ SCE_POWERSHELL_ALIAS, 63482, EDITSTYLE_HOLE(L"Alias"), L"bold; fore:#0080C0" },
	EDITSTYLE_SENTINEL
}
};
