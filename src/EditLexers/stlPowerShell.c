...
"Get-MarkdownOption Get-Member Get-Module Get-OperationValidation Get-PSBreakpoint Get-PSCallStack Get-PSDrive "
"Get-PSHostProcessInfo Get-PSProvider Get-PSReadLineKeyHandler Get-PSReadLineOption Get-PSRepository "
"Get-PSSession Get-PSSessionCapability Get-PSSessionConfiguration Get-PSSnapin Get-PSSubsystem "
"Get-Package Get-PackageProvider Get-PackageSource Get-PfxCertificate Get-Process "
...
"Get-WSManCredSSP Get-WSManInstance Get-WinEvent Get-WmiObject Group-Object "
"Import-Alias Import-BinaryMiLog Import-Clixml Import-Counter Import-Csv Import-LocalizedData Import-Module "
"Import-PSSession Import-PackageProvider Import-PowerShellDataFile "
...
"Invoke-WSManAction Invoke-WebRequest Invoke-WmiMethod "
...
"New-WSManInstance New-WSManSessionOption New-WebServiceProxy New-WinEvent "
"Out-Default Out-File Out-GridView Out-Host Out-Null Out-Printer Out-String "
"PSConsoleHostReadLine Pop-Location Protect-CmsMessage Publish-Module Publish-Script Push-Location "
"Read-Host Receive-Job Receive-PSSession Register-ArgumentCompleter Register-CimIndicationEvent Register-EngineEvent "
"Register-ObjectEvent Register-PSRepository Register-PSSessionConfiguration Register-PackageSource Register-ScheduledJob "
...
"Remove-Service Remove-TypeData Remove-Variable Remove-WSManInstance Remove-WmiObject "
...
"Set-PackageSource Set-ScheduledJob Set-ScheduledJobOption Set-Service Set-StrictMode Set-TimeZone Set-TraceSource "
"Set-Variable Set-WSManInstance Set-WSManQuickConfig Set-WmiInstance "
"Show-Command Show-ControlPanelItem Show-EventLog Show-Markdown Sort-Object Split-Path "
...
"Test-PSSessionConfigurationFile Test-Path Test-ScriptFileInfo Test-WSMan Trace-Command "
"Unblock-File Undo-Transaction Uninstall-Module Uninstall-Package Uninstall-Script Unprotect-CmsMessage Unregister-Event "
"Unregister-PSRepository Unregister-PSSessionConfiguration Unregister-PackageSource Unregister-ScheduledJob "
...
"Alias ConfirmPreference ConsoleFileName DebugPreference "
"EnabledExperimentalFeatures Env Error ErrorActionPreference ErrorView Event EventArgs EventSubscriber ExecutionContext "
"FormatEnumerationLimit Function HOME Host InformationPreference IsCoreCLR IsLinux IsMacOS IsWindows "
...
"Matches MaximumHistoryCount MyInvocation NestedPromptLevel OFS OutputEncoding "
"PID PROFILE PSBoundParameters PSCmdlet PSCommandPath PSCulture PSDebugContext PSDefaultParameterValues "
"PSEdition PSEmailServer PSHOME PSItem PSModuleAutoLoadingPreference PSNativeCommandArgumentPassing "
"PSScriptRoot PSSenderInfo PSSessionApplicationName PSSessionConfigurationName PSSessionOption PSStyle PSUICulture "
"PSVersionTable PWD ProgressPreference "
"Sender ShellId StackTrace Transcript Variable VerbosePreference WarningPreference WhatIfPreference args false foreach "
"input null switch this true "
...
//Settings++Autogenerated -- start of section automatically generated
	{
		...
		| KeywordAttr32(2, KeywordAttr_MakeLower) // cmdlet
		| KeywordAttr32(3, KeywordAttr_PreSorted) // alias
		| KeywordAttr32(4, KeywordAttr_MakeLower) // pre-defined variables
