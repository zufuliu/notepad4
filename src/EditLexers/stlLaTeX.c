...
EDITLEXER lexLaTeX = { SCLEX_LATEX, NP2LEX_LATEX, EDITLEXER_HOLE(L"LaTeX File"), L"tex; latex; sty; cls; tpx; bbl; bib; ltx; dtx; ins; toc; info", &Keywords_TEX,
{
	...
	{ MULTI_STYLE(SCE_L_SECTION, SCE_L_SECTION1, SCE_L_SECTION2, 0), 63511, EDITSTYLE_HOLE(L"Section"), L"fore:#008000" },
	...
	{ SCE_L_CMDOPT, 63574, EDITSTYLE_HOLE(L"Option"), L"fore:#1E90FF" },
