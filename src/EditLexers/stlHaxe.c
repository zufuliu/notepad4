...
"false final for from function if implements import in inline interface macro never new null operator overload override "
"package private public return static switch this throw to trace true try typedef untyped using var while "
...
static EDITSTYLE Styles_Haxe[] = {
	...
	{ MULTI_STYLE(SCE_HAXE_STRINGDQ, SCE_HAXE_STRINGSQ, SCE_HAXE_STRING_BEGIN, SCE_HAXE_STRING_END), NP2StyleX_String, L"fore:#008000" },
	...
	{ SCE_HAXE_VARIABLE, NP2StyleX_Variable, L"fore:#9E4D2A" },
