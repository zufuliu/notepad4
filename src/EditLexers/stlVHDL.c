...
EDITLEXER lexVHDL = { SCLEX_VHDL, NP2LEX_VHDL, EDITLEXER_HOLE(L"VHDL Source"), L"vhd; vhdl", &Keywords_VHDL,
{
	EDITSTYLE_DEFAULT,
	...
	{ SCE_VHDL_STDPACKAGE, 63581, EDITSTYLE_HOLE(L"STD Package"), L"bold; fore:#0000FF" },
	{ SCE_VHDL_STDOPERATOR, 63582, EDITSTYLE_HOLE(L"STD Operator"), L"fore:#0080C0" },
	{ SCE_VHDL_STDFUNCTION, 63583, EDITSTYLE_HOLE(L"STD Function"), L"bold; fore:#0080C0" },
	{ SCE_VHDL_STDTYPE, 63584, EDITSTYLE_HOLE(L"STD Type"), L"bold; fore:#FF8000" },
	{ SCE_VHDL_USERWORD, 63585, EDITSTYLE_HOLE(L"User Define"), L"fore:#B5E71F" },
	EDITSTYLE_SENTINEL
}
};
