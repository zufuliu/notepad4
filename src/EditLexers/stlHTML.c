...
static EDITSTYLE Styles_HTML[] = {
	EDITSTYLE_DEFAULT,
	{ MULTI_STYLE(SCE_H_TAG, SCE_H_TAGEND, 0, 0), NP2STYLE_HTMLTag, EDITSTYLE_HOLE(L"HTML Tag"), L"fore:#648000" },
	{ SCE_H_TAGUNKNOWN, NP2STYLE_HTMLUnknownTag, EDITSTYLE_HOLE(L"HTML Unknown Tag"), L"fore:#C80000" },
	{ SCE_H_ATTRIBUTE, NP2STYLE_HTMLAttribute, EDITSTYLE_HOLE(L"HTML Attribute"), L"fore:#FF4000" },
	{ SCE_H_ATTRIBUTEUNKNOWN, NP2STYLE_HTMLUnknownAttribute, EDITSTYLE_HOLE(L"HTML Unknown Attribute"), L"fore:#C80000" },
	{ SCE_H_VALUE, NP2STYLE_HTMLValue, EDITSTYLE_HOLE(L"HTML Value"), L"fore:#3A6EA5" },
	{ MULTI_STYLE(SCE_H_DOUBLESTRING, SCE_H_SINGLESTRING, 0, 0), NP2STYLE_HTMLString, EDITSTYLE_HOLE(L"HTML String"), L"fore:#3A6EA5" },
	{ SCE_H_OTHER, NP2STYLE_HTMLOtherTag, EDITSTYLE_HOLE(L"HTML Other Tag"), L"fore:#3A6EA5" },
	{ MULTI_STYLE(SCE_H_COMMENT, SCE_H_XCCOMMENT, 0, 0), NP2STYLE_HTMLComment, EDITSTYLE_HOLE(L"HTML Comment"), L"fore:#608060" },
	{ SCE_H_ENTITY, NP2STYLE_HTMLEntity, EDITSTYLE_HOLE(L"HTML Entity"), L"fore:#B000B0" },
	{ SCE_H_DEFAULT, NP2STYLE_HTMLElementText, EDITSTYLE_HOLE(L"HTML Element Text"), L"" },
	...
	{ MULTI_STYLE(SCE_H_ASP, SCE_H_ASPAT, 0, 0), NP2STYLE_ASPTag, EDITSTYLE_HOLE(L"ASP Tag"), L"bold; fore:#8B008B" },
	//{ SCE_H_SCRIPT, EDITSTYLE_HOLE(L"Script"), L"" },
	{ SCE_H_QUESTION, NP2STYLE_PHPTag, EDITSTYLE_HOLE(L"PHP Tag"), L"bold; fore:#8B008B" },
	/////////////////////////////////// PHP
	{ SCE_HPHP_DEFAULT, NP2STYLE_PHPDefault, EDITSTYLE_HOLE(L"PHP Default"), L"" },
	{ MULTI_STYLE(SCE_HPHP_COMMENT, SCE_HPHP_COMMENTLINE, 0, 0), NP2STYLE_PHPComment, EDITSTYLE_HOLE(L"PHP Comment"), L"fore:#608060" },
	{ SCE_HPHP_WORD, NP2STYLE_PHPKeyword, EDITSTYLE_HOLE(L"PHP Keyword"), L"bold; fore:#FF8000" },
	{ MULTI_STYLE(SCE_HPHP_HSTRING, SCE_HPHP_SIMPLESTRING, 0, 0), NP2STYLE_PHPString, EDITSTYLE_HOLE(L"PHP String"), L"fore:#008000" },
	{ SCE_HPHP_HEREDOC, NP2STYLE_PHPHeredocString, EDITSTYLE_HOLE(L"PHP Heredoc String"), L"fore:#648000" },
	{ SCE_HPHP_NOWDOC, NP2STYLE_PHPNowdocString, EDITSTYLE_HOLE(L"PHP Nowdoc String"), L"fore:#A46000" },
	{ SCE_HPHP_NUMBER, NP2STYLE_PHPNumber, EDITSTYLE_HOLE(L"PHP Number"), L"fore:#FF0000" },
	{ SCE_HPHP_OPERATOR, NP2STYLE_PHPOperator, EDITSTYLE_HOLE(L"PHP Operator"), L"fore:#B000B0" },
	{ SCE_HPHP_VARIABLE, NP2STYLE_PHPVariable, EDITSTYLE_HOLE(L"PHP Variable"), L"italic; fore:#003CE6" },
	{ SCE_HPHP_HSTRING_VARIABLE, NP2STYLE_PHPStringVariable, EDITSTYLE_HOLE(L"PHP String Variable"), L"fore:#000080" },
	{ SCE_HPHP_COMPLEX_VARIABLE, NP2STYLE_PHPComplexVariable, EDITSTYLE_HOLE(L"PHP Complex Variable"), L"fore:#000080" },
	////////////////////////////////// JavaScript
	{ MULTI_STYLE(SCE_HJ_DEFAULT, SCE_HJ_START, 0, 0), NP2STYLE_JSDefault, EDITSTYLE_HOLE(L"JS Default"), L"" },
	{ MULTI_STYLE(SCE_HJ_COMMENT, SCE_HJ_COMMENTLINE, SCE_HJ_COMMENTDOC, 0), NP2STYLE_JSComment, EDITSTYLE_HOLE(L"JS Comment"), L"fore:#608060" },
	{ SCE_HJ_KEYWORD, NP2STYLE_JSKeyword, EDITSTYLE_HOLE(L"JS Keyword"), L"bold; fore:#FF8000" },
	{ MULTI_STYLE(SCE_HJ_DOUBLESTRING, SCE_HJ_SINGLESTRING, SCE_HJ_STRINGEOL, 0), NP2STYLE_JSString, EDITSTYLE_HOLE(L"JS String"), L"fore:#008000" },
	{ SCE_HJ_REGEX, NP2STYLE_JSRegex, EDITSTYLE_HOLE(L"JS Regex"), L"fore:#006633; back:#FFF1A8" },
	{ SCE_HJ_NUMBER, NP2STYLE_JSNumber, EDITSTYLE_HOLE(L"JS Number"), L"fore:#FF0000" },
	{ SCE_HJ_SYMBOLS, NP2STYLE_JSSymbol, EDITSTYLE_HOLE(L"JS Symbol"), L"fore:#B000B0" },
	/////////////////////////////////// ASP Javascript
	{ MULTI_STYLE(SCE_HJA_DEFAULT, SCE_HJA_START, 0, 0), NP2STYLE_ASPJSDefault, EDITSTYLE_HOLE(L"ASP JS Default"), L"" },
	{ MULTI_STYLE(SCE_HJA_COMMENT, SCE_HJA_COMMENTLINE, SCE_HJA_COMMENTDOC, 0), NP2STYLE_ASPJSComment, EDITSTYLE_HOLE(L"ASP JS Comment"), L"fore:#608060" },
	{ SCE_HJA_KEYWORD, NP2STYLE_ASPJSKeyword, EDITSTYLE_HOLE(L"ASP JS Keyword"), L"bold; fore:#FF8000" },
	{ MULTI_STYLE(SCE_HJA_DOUBLESTRING, SCE_HJA_SINGLESTRING, SCE_HJA_STRINGEOL, 0), NP2STYLE_ASPJSString, EDITSTYLE_HOLE(L"ASP JS String"), L"fore:#008000" },
	{ SCE_HJA_REGEX, NP2STYLE_ASPJSRegex, EDITSTYLE_HOLE(L"ASP JS Regex"), L"fore:#006633; back:#FFF1A8" },
	{ SCE_HJA_NUMBER, NP2STYLE_ASPJSNumber, EDITSTYLE_HOLE(L"ASP JS Number"), L"fore:#FF0000" },
	{ SCE_HJA_SYMBOLS, NP2STYLE_ASPJSSymbol, EDITSTYLE_HOLE(L"ASP JS Symbol"), L"fore:#B000B0" },
	////////////////////////////////////// VBS
	{ MULTI_STYLE(SCE_HB_DEFAULT, SCE_HB_START, 0, 0), NP2STYLE_VBSDefault, EDITSTYLE_HOLE(L"VBS Default"), L"" },
	{ SCE_HB_COMMENTLINE, NP2STYLE_VBSComment, EDITSTYLE_HOLE(L"VBS Comment"), L"fore:#608060" },
	{ SCE_HB_WORD, NP2STYLE_VBSKeyword, EDITSTYLE_HOLE(L"VBS Keyword"), L"bold; fore:#FF8000" },
	{ MULTI_STYLE(SCE_HB_STRING, SCE_HB_STRINGEOL, 0, 0), NP2STYLE_VBSString, EDITSTYLE_HOLE(L"VBS String"), L"fore:#008000" },
	{ SCE_HB_NUMBER, NP2STYLE_VBSNumber, EDITSTYLE_HOLE(L"VBS Number"), L"fore:#FF0000" },
	///////////////////////////////////// ASP VBS
	{ MULTI_STYLE(SCE_HBA_DEFAULT, SCE_HBA_START, 0, 0), NP2STYLE_ASPVBSDefault, EDITSTYLE_HOLE(L"ASP VBS Default"), L"" },
	{ SCE_HBA_COMMENTLINE, NP2STYLE_ASPVBSComment, EDITSTYLE_HOLE(L"ASP VBS Comment"), L"fore:#608060" },
	{ SCE_HBA_WORD, NP2STYLE_ASPVBSKeyword, EDITSTYLE_HOLE(L"ASP VBS Keyword"), L"bold; fore:#FF8000" },
	{ MULTI_STYLE(SCE_HBA_STRING, SCE_HBA_STRINGEOL, 0, 0), NP2STYLE_ASPVBSString, EDITSTYLE_HOLE(L"ASP VBS String"), L"fore:#008000" },
	{ SCE_HBA_NUMBER, NP2STYLE_ASPVBSNumber, EDITSTYLE_HOLE(L"ASP VBS Number"), L"fore:#FF0000" },
