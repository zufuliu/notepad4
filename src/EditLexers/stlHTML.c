...
EDITLEXER lexHTML = { SCLEX_HTML, NP2LEX_HTML, L"Web Source Code", L"html; htm; shtml; xhtml; asp; aspx; jsp; mht; htd; htt; hta; htc; cfm; tpl; jd", L"", &Keywords_HTML,
{
	...
	{ MULTI_STYLE(SCE_H_COMMENT, SCE_H_XCCOMMENT, 0, 0), 63168, L"HTML Comment", L"fore:#608060", L"" },
	...
	{ MULTI_STYLE(SCE_HPHP_COMMENT, SCE_HPHP_COMMENTLINE, 0, 0), 63182, L"PHP Comment", L"fore:#608060", L"" },
	...
	{ MULTI_STYLE(SCE_HJ_COMMENT, SCE_HJ_COMMENTLINE, SCE_HJ_COMMENTDOC, 0), 63202, L"JS Comment", L"fore:#608060", L"" },
	...
	{ MULTI_STYLE(SCE_HJA_COMMENT, SCE_HJA_COMMENTLINE, SCE_HJA_COMMENTDOC, 0), 63212, L"ASP JS Comment", L"fore:#608060", L"" },
	...
	{ SCE_HB_COMMENTLINE, 63222, L"VBS Comment", L"fore:#608060", L"" },
	...
	{ SCE_HBA_COMMENTLINE, 63232, L"ASP VBS Comment", L"fore:#608060", L"" },
