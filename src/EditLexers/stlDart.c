...
static EDITSTYLE Styles_Dart[] = {
	...
	{ MULTI_STYLE(SCE_DART_TRIPLE_STRING_SQ, SCE_DART_TRIPLE_STRING_DQ, SCE_DART_TRIPLE_STRINGSTART, SCE_DART_TRIPLE_STRINGEND), NP2StyleX_TripleQuotedString, L"fore:#F08000" },
