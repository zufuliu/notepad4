...
static EDITSTYLE Styles_Rust[] = {
	...
	{ SCE_RUST_FUNCTION_DEFINE, NP2STYLE_FunctionDefine, EDITSTYLE_HOLE(L"Function Define"), L"bold; fore:#A46000" },
	...
	{ SCE_RUST_LIFETIME, NP2STYLE_Lifetime, EDITSTYLE_HOLE(L"Lifetime"), L"fore:#7C5AF3" },
