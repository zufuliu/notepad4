...
, // 3 struct
"AccessError AddrParseError Ancestors Arc Args ArgsOs Arguments AssertUnwindSafe "
...
"ManuallyDrop Map MatchIndices Matches Metadata Mutex MutexGuard NonNull NulError Once OpenOptions OsStr OsString Output "
"PanicInfo ParseBoolError ParseCharError Path PathBuf Peekable Permissions PhantomData PhantomPinned Pin PoisonError "
"PrefixComponent "
"RChunks RChunksExact RChunksExactMut RChunksMut RMatchIndices RMatches "
"RSplit RSplitMut RSplitN RSplitNMut RSplitTerminator RawWaker RawWakerVTable Rc "
"ReadDir Ref RefCell RefMut Repeat RepeatWith Rev Reverse RwLock RwLockReadGuard RwLockWriteGuard "
"Scan Sink Skip SkipWhile SocketAddrV4 SocketAddrV6 "
...
"System SystemTime SystemTimeError "
"Take TakeWhile TcpListener TcpStream Thread ThreadId ToLowercase ToUppercase TryFromSliceError TypeId "
"UdpSocket UnsafeCell Utf8Error Vars VarsOs Vec VecDeque WaitTimeoutResult Waker Weak Windows Zip "

, // 4 trait
"Any AsMut AsRef Binary Borrow BorrowMut BufRead BuildHasher Clone Copy Debug Default DoubleEndedIterator "
"Eq ExactSizeIterator Extend From FromIterator FromStr FusedIterator Future GlobalAlloc Hash Hasher "
"Into IntoIterator Iterator LowerExp LowerHex Octal Ord PartialEq PartialOrd Pointer Product Read RefUnwindSafe "
"Seek Send Sized SliceIndex Sum Sync ToOwned ToSocketAddrs ToString TryFrom TryInto Unpin UnwindSafe UpperExp UpperHex "
"Write "

, // 5 enumeration
"AddrInUse AddrNotAvailable Alignment AlreadyExists Borrowed Both BrokenPipe "
"Center Component ConnectionAborted ConnectionRefused ConnectionReset Cow CurDir Current DeviceNS Disk "
"End Equal Err ErrorKind Greater Infallible Interrupted InvalidData InvalidInput IpAddr Left Less LockResult "
"None Normal NotConnected NotFound NotPresent NotUnicode Ok Option Ordering Other Owned "
"ParentDir ParseError Pending PermissionDenied Poisoned Poll Prefix Ready Result Right RootDir "
"SeekFrom Shutdown SocketAddr Some Start TimedOut TryLockError TryLockResult UNC UnexpectedEof "
"V4 V6 VarError Verbatim VerbatimDisk VerbatimUNC WouldBlock WriteZero c_void "
...
, // 11 function
"abort( abs( accept( accessed( acos( acosh( add( "
...
"atan( atan2( atanh( "
"back( back_mut( binary_search( binary_search_by( binary_search_by_key( bind( borrow( borrow_mut( broadcast( "
"buffer( build_hasher( by_ref( bytes( "
"call_once( canonicalize( capacity( cast( catch_unwind( cbrt( ceil( chain( char_indices( chars( "
...
"code( collect( column( components( concat( connect( connect_timeout( consume( contains( contains_key( copied( copy( "
...
"dedup( dedup_by( dedup_by_key( default( description( difference( discriminant( display( div_euclid( div_f32( div_f64( "
"downcast( downcast_mut( downcast_ref( downgrade( drain( drop( drop_in_place( duration( duration_since( "
"elapsed( empty( encode_utf16( encode_utf8( ends_with( entries( entry( enumerate( env( env_clear( env_remove( envs( "
...
"field( file( file_name( file_stem( file_type( fill( fill_buf( filter( filter_map( find( find_map( finish( "
"first( first_mut( flat_map( flatten( floor( flowinfo( flush( fmt( fold( for_each( for_value( forget( format( fract( "
"from( from_be( from_be_bytes( from_bits( from_boxed_utf8_unchecked( from_bytes_with_nul( from_bytes_with_nul_unchecked( "
...
"id( identity( incoming( inherit( insert( insert_str( inspect( intersection( into( "
...
"ln( ln_1p( local_addr( location( lock( log( log10( log2( lt( "
...
"mul_add( mul_f32( mul_f64( multicast_loop_v4( multicast_loop_v6( multicast_ttl_v4( "
"name( ne( needs_drop( new( new_unchecked( next( next_back( next_power_of_two( nodelay( notify_all( notify_one( now( "
"nth( nth_back( nul_position( null( null_mut( "
...
"read_vectored( read_volatile( readonly( realloc( recip( recursive( recv( recv_from( "
"rem_euclid( remainder( remove( remove_dir( remove_dir_all( remove_entry( remove_file( remove_var( rename( "
"repeat( repeat_with( replace( replace_range( replace_with( replacen( "
...
"set_write_timeout( shrink_to_fit( shutdown( "
...
"splice( split( split_ascii_whitespace( split_at( split_at_mut( split_first( split_first_mut( "
"split_last( split_last_mut( split_mut( split_off( split_paths( split_terminator( split_whitespace( splitn( splitn_mut( "
"sqrt( stack_size( starts_with( status( stderr( stdin( stdout( step_by( strip_prefix( strong_count( "
"sub( subsec_micros( subsec_millis( subsec_nanos( success( successors( sum( "
"swap( swap_bytes( swap_nonoverlapping( swap_remove( swap_remove_back( swap_remove_front( swap_with_slice( "
"symlink_metadata( symmetric_difference( sync_all( sync_data( "
...
"try_borrow( try_borrow_mut( try_borrow_unguarded( try_clone( try_fold( try_for_each( try_from( try_into( try_lock( "
"try_read( try_rfold( try_unwrap( try_wait( try_with( try_write( ttl( type_id( "
...
static EDITSTYLE Styles_Rust[] = {
	...
	{ SCE_RUST_MACRO, 63463, EDITSTYLE_HOLE(L"Macro"), L"fore:#FF8000" },
	...
	{ MULTI_STYLE(SCE_RUST_BYTESTRING, SCE_RUST_BYTE_CHARACTER, 0, 0), 63461, EDITSTYLE_HOLE(L"Bytes"), L"fore:#C08000" },
	{ SCE_RUST_RAW_BYTESTRING, 63462, EDITSTYLE_HOLE(L"Raw Bytes"), L"fore:#648000" },
