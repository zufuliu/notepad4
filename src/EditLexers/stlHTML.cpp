...
static const char * const Keywords_HTML[] = {
...
"cellpadding cellspacing challenge char charoff charset checked cite class classid clear closedby code codebase codetype "
"color colorspace cols colspan command commandfor compact content contenteditable contextmenu controls coords "
"crossorigin "
...
"onchange onclick onclose oncommand oncontextlost oncontextmenu oncontextrestored oncopy oncuechange oncut "
...
"sandbox scheme scope scrollamount scrolldelay scrolling selected shadowrootclonable shadowrootcustomelementregistry "
"shadowrootdelegatesfocus shadowrootmode shadowrootserializable shadowrootslotassignment shape size sizes slot "
"span spellcheck src srcdoc srclang srcset standby start step style summary "
...
"blob bookmark "
"canonical captions chapters characters checkbox circ circle close closed closerequest "
...
"dns-prefetch done "
"eager email en enter expect external false fetch file generator get go hard help hide hide-popover hint http https "
...
"same-origin self send sentences set-cookie show show-modal show-popover sms soft "
"strict-origin strict-origin-when-cross-origin stylesheet submit subtitles sync "
"tag tel terms-of-service text/css text/ecmascript text/javascript text/jscript text/livescript text/plain text/xml "
"theme-color toggle toggle-popover true "
...
static const EDITSTYLE Styles_HTML[] = {
	EDITSTYLE_DEFAULT,
...
//Settings--Autogenerated -- end of section automatically generated
	EDITLEXER_HOLE(L"Web Source Code", Keywords_HTML, Styles_HTML),
