...
"isArray( isDefaultNamespace( isDisjointFrom( isEqualNode( isExtensible( isFinite( isFrozen( isInteger( isLockFree( "
"isNaN( isPrototypeOf( isSafeInteger( isSameNode( isSealed( isSubsetOf( isSupersetOf( isView( isWellFormed( "
"italics( item( "
...
"setFloat16( setFloat32( setFloat64( setFullYear( setHours( setInt16( setInt32( setInt8( setInterval( setItem( "
...
"sub( subarray( substr( substring( sup( symmetricDifference( "
"table( take( tan( tanh( terminate( test( then( throw( time( timeEnd( timeLog( toArray( toDateString( toExponential( "
"toFixed( toGMTString( toISOString( toJSON( "
...
"trace( trim( trimEnd( trimLeft( trimRight( trimStart( trunc( try( "
