...
static const char * const Keywords_JS[] = {
...
, // 6 constant
"BYTES_PER_ELEMENT DONE EPSILON HEADERS_RECEIVED LN10 LN2 LOADING LOG10E LOG2E "
...
"difference( dimensions( dir( dirxml( dispatchEvent( drop( "
...
"f16round( fetch( fill( filter( finally( find( findIndex( findLast( findLastIndex( fixed( flat( flatMap( floor( "
"focus( fontcolor( fontsize( for( forEach( "
"freeze( from( fromAsync( fromBase64( fromCharCode( fromCodePoint( fromEntries( fromHex( fround( function( "
...
"getFloat16( getFloat32( getFloat64( getFullYear( getHours( getInt16( getInt32( getInt8( getItem( "
"getMilliseconds( getMinutes( getMonth( getOrInsert( getOrInsertComputed( "
...
"getUint16( getUint32( getUint8( getYear( group( groupBy( groupCollapsed( groupEnd( grow( "
...
"includes( indexOf( info( insertAdjacentElement( insertAdjacentHTML( insertAdjacentText( insertBefore( intersection( is( "
"isArray( isDefaultNamespace( isDisjointFrom( isEqualNode( isError( isExtensible( isFinite( isFrozen( isInteger( "
"isLockFree( isNaN( isPrototypeOf( isRawJSON( isSafeInteger( isSameNode( isSealed( isSubsetOf( isSupersetOf( isView( "
"isWellFormed( italics( item( "
...
"race( random( raw( rawJSON( reduce( reduceRight( register( reject( releasePointerCapture( "
...
"resize( resizeBy( resizeTo( resolve( return( reverse( revocable( round( "
...
"setFloat16( setFloat32( setFloat64( setFromHex( setFullYear( setHours( "
"setInt16( setInt32( setInt8( setInterval( setItem( setMilliseconds( setMinutes( setMonth( "
"setPointerCapture( setPrototypeOf( setRequestHeader( setSeconds( setTime( setTimeout( "
...
"sub( subarray( substr( substring( sumPrecise( sup( symmetricDifference( "
"table( take( tan( tanh( terminate( test( then( throw( time( timeEnd( timeLog( toArray( toBase64( toDateString( "
"toExponential( toFixed( toGMTString( toHex( toISOString( toJSON( "
...
"trace( transfer( transferToFixedLength( trim( trimEnd( trimLeft( trimRight( trimStart( trunc( try( "
"ubound( unescape( union( unregister( unshift( valueOf( values( "
...
"defaultView description designMode detached devicePixelRatio dir "
"doctype document documentElement documentURI domain dotAll "
"embeds event "
"firstChild firstElementChild flags fonts forms frameElement frames fullScreen fullscreenElement fullscreenEnabled "
"global growable hasIndices hasInstance head hidden history "
...
"match matchAll maxByteLength menubar message multiline "
...
"readyState referrer replace resizable response responseText responseType responseURL responseXML "
...
"tagName textContent timeline timeout title toPrimitive toStringTag toolbar top unicode unicodeSets unscopables upload "
...
//Settings--Autogenerated -- end of section automatically generated
	EDITLEXER_HOLE(L"JavaScript", Keywords_JS, Styles_JS),
