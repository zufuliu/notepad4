...
static EDITSTYLE Styles_Gradle[] = {
	...
	{ SCE_C_ENUMERATION, NP2STYLE_Action, EDITSTYLE_HOLE(L"Action"), L"fore:#FF8000" },
	{ SCE_C_CONSTANT, NP2STYLE_Property, EDITSTYLE_HOLE(L"Property"), L"fore:#B000B0" },
	{ MULTI_STYLE(SCE_C_COMMENT, SCE_C_COMMENTLINE, 0, 0), NP2STYLE_Comment, EDITSTYLE_HOLE(L"Comment"), L"fore:#008000" },
	{ SCE_C_COMMENTDOC_TAG, NP2STYLE_DocCommentTag, EDITSTYLE_HOLE(L"Doc Comment Tag"), L"bold; fore:#408080" },
	{ SCE_C_COMMENTDOC_TAG_XML, NP2STYLE_DocCommentTagHTML, EDITSTYLE_HOLE(L"Doc Comment HTML Tag"), L"bold; fore:#808080" },
