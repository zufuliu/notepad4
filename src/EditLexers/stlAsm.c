...
EDITLEXER lexASM = { SCLEX_ASM, NP2LEX_ASM, L"Assembler Source", L"asm; s", L"", &Keywords_ASM,
{
	...
	{ SCE_ASM_CPUINSTRUCTION, 63551, L"CPU Instruction", L"fore:#0080FF", L"" },
	{ SCE_ASM_MATHINSTRUCTION, 63552, L"FPU Instruction", L"fore:#FF0080", L"" },
	{ SCE_ASM_EXTINSTRUCTION, 63553, L"Extended Instruction", L"fore:#8000FF", L"" },
	{ SCE_ASM_DIRECTIVE, NP2STYLE_Directive, L"Directive", L"fore:#0000FF", L"" },
	{ SCE_ASM_DIRECTIVEOPERAND, 63554, L"Directive Operand", L"fore:#0000FF", L"" },
	{ SCE_ASM_REGISTER, NP2STYLE_Register, L"Register", L"fore:#FF8000", L"" },
	{ SCE_ASM_LABEL, NP2STYLE_Label, L"Label", L"fore:#000000; back:#FFC040", L""},
	{ -1, 00000, L"", L"", L"" }
}
};
