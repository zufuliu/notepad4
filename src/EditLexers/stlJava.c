...
"@interface abstract assert break case catch class const continue default do else enum extends false final finally for "
"goto if implements import instanceof interface native new non-sealed null package parcelable private protected public "
...
"Point PointF PrintStream PrintWriter PriorityQueue Process ProcessBuilder ProgressBar Properties "
...
"Scanner ScrollView SearchView SecurityManager SeekBar Semaphore ServerSocket Service ServiceLoader Short ShortBuffer "
"SimpleDateFormat Socket SocketAddress SoftReference Spinner "
...
"URI URL URLDecoder URLEncoder UUID Vector View ViewGroup Void WeakHashMap WeakReference Window Writer "
...
, // 7 annotation
"Basic Column Deprecated Documented Entity FunctionalInterface Generated Id Inherited ManagedBean "
...
static EDITSTYLE Styles_Java[] = {
	EDITSTYLE_DEFAULT,
	{ MULTI_STYLE(SCE_JAVA_WORD, SCE_JAVA_WORD_DEMOTED, 0, 0), NP2StyleX_Keyword, L"fore:#0000FF" },
