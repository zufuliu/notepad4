...
"DECLARE_HANDLE() DECLSPEC_UUID() DEFINE_GUID() MAKEWORD() MAKELONG() LOWORD() HIWORD() LOBYTE() HIBYTE() RGB() CMYK() TEXT() __TEXT() "
"WM_APP WM_USER "
"SUCCEEDED() FAILED() ASSERT() VERIFY() TRACE() DECLARE_DYNAMIC() afx_msg BEGIN_MESSAGE_MAP() END_MESSAGE_MAP() "
...
EDITLEXER lexCPP = { SCLEX_CPP, NP2LEX_CPP, EDITLEXER_HOLE, L"C/C++ Source", L"c; cpp; cxx; cc; h; hpp; hxx; hh; inl; pch; mm", L"", &Keywords_CPP,
{
	...
	{ SCE_C_2NDWORD2, NP2STYLE_Type, L"Type", L"fore:#007F7F", L"" },
	...
	{ MULTI_STYLE(SCE_C_MACRO2, SCE_C_MACRO, 0, 0), NP2STYLE_Macro, L"Macro", L"fore:#B000B0", L""},
	...
	{ SCE_C_STRINGRAW, NP2STYLE_RawString, L"Raw String", L"fore:#E24000", L"" },
