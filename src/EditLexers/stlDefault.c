...
//Text Settings++Autogenerated -- start of section automatically generated
	{
		LexerAttr_NoLineComment | LexerAttr_NoBlockComment | LexerAttr_IndentBasedFolding | LexerAttr_IndentLookForward,
...
//Diff Settings++Autogenerated -- start of section automatically generated
	{
		LexerAttr_NoLineComment | LexerAttr_NoBlockComment,
		TAB_WIDTH_4, INDENT_WIDTH_4
	},
