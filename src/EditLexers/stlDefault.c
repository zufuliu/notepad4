...
static EDITSTYLE Styles_Default[] = {
	...
	{ STYLE_LINENUMBER, 63113, EDITSTYLE_HOLE(L"2nd Margin and Line Number"), L"size:-2; fore:#A0A0A0; back:#2A2A2E" },
	{ STYLE_BRACELIGHT, 63114, EDITSTYLE_HOLE(L"2nd Matching Brace"), L"size:+1; bold; fore:#FF0000" },
	{ STYLE_BRACEBAD, 63115, EDITSTYLE_HOLE(L"2nd Matching Brace Error"), L"size:+1; bold; fore:#000080" },
	{ STYLE_CONTROLCHAR, 63116, EDITSTYLE_HOLE(L"2nd Control Character"), L"size:-1" },
	{ STYLE_INDENTGUIDE, 63117, EDITSTYLE_HOLE(L"2nd Indentation Guide"), L"fore:#605F63" },
	{ SCI_SETSELFORE + SCI_SETSELBACK, 63118, EDITSTYLE_HOLE(L"2nd Selected Text"), L"eolfilled; alpha:95" },
	...
	{ SCI_SETCARETLINEBACK, 63120, EDITSTYLE_HOLE(L"2nd Current Line"), L"size:2; fore:#C2C0C3; back:#FFFF00; alpha:50" },
	{ SCI_SETCARETFORE + SCI_SETCARETWIDTH, 63121, EDITSTYLE_HOLE(L"2nd Caret"), L"fore:#FFFFFF" },
