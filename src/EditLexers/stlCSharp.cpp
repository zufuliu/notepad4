...
"readonly record ref remove required return scoped sealed select set sizeof stackalloc static struct switch "
"this throw true try typeof unchecked unmanaged unsafe using value var virtual volatile when where while with yield "
