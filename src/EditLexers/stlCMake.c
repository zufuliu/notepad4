...
"CACHED_VARIABLE CAPTURE_CMAKE_ERROR CASE CLEAR CMAKE_FIND_ROOT_PATH_BOTH CMAKE_FLAGS CODE "
...
"IF IMPLICIT_DEPENDS IMPORTED IN INACTIVITY_TIMEOUT INCLUDE INCLUDES INCLUDE_INTERNALS INCLUDE_LABEL INHERITED "
...
"GENERATED GNUtoMS HELPSTRING HOSTNAME LANGUAGE LOCATION MACROS MEASUREMENT MODIFIED PROCESSES PROCESSORS "
...
"IGNORE IGNORED INFO LF LIB LOCALE LOCALSTATE MAN MemCheck MinSizeRel NO NONE NOTFOUND Notes "
...
static EDITSTYLE Styles_CMake[] = {
	...
	{ SCE_CMAKE_PARAMETERS, NP2STYLE_Parameter, EDITSTYLE_HOLE(L"Parameter"), L"fore:#0C71C3" },
	{ SCE_CMAKE_PROPERTIES, NP2STYLE_Property, EDITSTYLE_HOLE(L"Property"), L"fore:#A46000" },
	{ SCE_CMAKE_VALUES, NP2STYLE_Value, EDITSTYLE_HOLE(L"Value"), L"fore:#008287" },
	...
	{ SCE_CMAKE_BRACKET_ARGUMENT, NP2STYLE_BracketArgument, EDITSTYLE_HOLE(L"Bracket Argument"), L"fore:#648000" },
