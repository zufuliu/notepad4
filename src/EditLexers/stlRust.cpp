...
static const char * const Keywords_Rust[] = {
//++Autogenerated -- start of section automatically generated
"Self as async await break const continue crate dyn else enum extern false fn for gen if impl in let loop "
"match mod move mut pub ref return self static struct super trait true type union unsafe use where while "
...
"f128 f16 f32 f64 i128 i16 i32 i64 i8 isize never pointer reference slice str tuple u128 u16 u32 u64 u8 unit usize "
...
, // 8 attribute
"align( all( allow( always any( cfg( cfg_attr( cold collapse_debuginfo( crate_name crate_type "
"debug_assertions debugger_visualizer( deny( deprecated deprecated( derive( doc enable expect( expected export_name "
"feature( forbid( global_allocator ignore inline inline( instruction_set( kind "
"lazy_static link( link_name link_ordinal( link_section local_inner_macros "
"macro_export macro_export( macro_use macro_use( must_use "
"naked name never no_builtins no_implicit_prelude no_link no_main no_mangle no_std non_exhaustive not( "
"packed( panic panic_handler path proc_macro proc_macro_attribute proc_macro_derive( recursion_limit repr( should_panic( "
"target_abi target_arch target_endian target_env target_family target_feature target_feature( target_has_atomic "
"target_os target_pointer_width target_vendor test track_caller type_length_limit "
"unix used warn( windows windows_subsystem "

, // 9 macro
"assert!( assert_eq!( assert_ne!( "
"cfg!( cfg_select!( column!( compile_error!( concat!( concat_bytes!( const_format_args!( "
"dbg!( debug_assert!( debug_assert_eq!( debug_assert_ne!( env!( eprint!( eprintln!( "
"file!( format!( format_args!( format_args_nl!( include!( include_bytes!( include_str!( is_x86_feature_detected!( "
"line!( log_syntax!( macro_rules! matches!( module_path!( option_env!( panic!( print!( println!( stringify!( "
"thread_local!( trace_macros!( unimplemented!( unreachable!( vec!( write!( writeln!( "
...
static const EDITSTYLE Styles_Rust[] = {
	EDITSTYLE_DEFAULT,
...
//Settings--Autogenerated -- end of section automatically generated
	EDITLEXER_HOLE(L"Rust Source", Keywords_Rust, Styles_Rust),
	L"rs",
	Keywords_Rust,
	Styles_Rust
};
