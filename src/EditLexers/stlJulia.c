...
"KeyError LinRange LinearIndices LoadError LogLevel LowerTriangular "
...
static EDITSTYLE Styles_Julia[] = {
	...
	{ MULTI_STYLE(SCE_JULIA_TRIPLE_STRING, SCE_JULIA_TRIPLE_STRINGSTART, SCE_JULIA_TRIPLE_STRINGEND, 0), NP2STYLE_TripleString, EDITSTYLE_HOLE(L"Triple Quoted String"), L"fore:#F08000" },
	...
	{ SCE_JULIA_SYMBOL, 63473, EDITSTYLE_HOLE(L"Symbol"), L"fore:#7C5AF3" },
