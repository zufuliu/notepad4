...
"if import in isa let local macro module mutable primitive quote return struct try type using where while "
...
static EDITSTYLE Styles_Julia[] = {
	EDITSTYLE_DEFAULT,
	{ MULTI_STYLE(SCE_JULIA_WORD, SCE_JULIA_WORD_DEMOTED, 0, 0), NP2STYLE_Keyword, EDITSTYLE_HOLE(L"Keyword"), L"fore:#0000FF" },
	{ SCE_JULIA_TYPE, NP2STYLE_Type, EDITSTYLE_HOLE(L"Type"), L"fore:#0080FF" },
	...
	{ SCE_JULIA_FUNCTION_DEFINE, NP2STYLE_FunctionDefine, EDITSTYLE_HOLE(L"Function Define"), L"bold; fore:#A46000" },
	...
	{ MULTI_STYLE(SCE_JULIA_TRIPLE_STRING, SCE_JULIA_TRIPLE_STRINGSTART, SCE_JULIA_TRIPLE_STRINGEND, 0), NP2STYLE_TripleQuotedString, EDITSTYLE_HOLE(L"Triple Quoted String"), L"fore:#F08000" },
	{ MULTI_STYLE(SCE_JULIA_RAWSTRING, SCE_JULIA_TRIPLE_RAWSTRING, 0, 0), NP2STYLE_RawString, EDITSTYLE_HOLE(L"Raw String"), L"fore:#008080" },
	{ MULTI_STYLE(SCE_JULIA_BYTESTRING, SCE_JULIA_TRIPLE_BYTESTRING, 0, 0), NP2STYLE_Bytes, EDITSTYLE_HOLE(L"Bytes"), L"fore:#C08000" },
	{ SCE_JULIA_ESCAPECHAR, NP2STYLE_EscapeSequence, EDITSTYLE_HOLE(L"Escape Sequence"), L"fore:#0080C0" },
	{ MULTI_STYLE(SCE_JULIA_BACKTICKS, SCE_JULIA_TRIPLE_BACKTICKS, SCE_JULIA_TRIPLE_BACKTICKSSTART, SCE_JULIA_TRIPLE_BACKTICKSEND), NP2STYLE_Backticks, EDITSTYLE_HOLE(L"Backticks"), L"fore:#FF0080" },
	{ MULTI_STYLE(SCE_JULIA_REGEX, SCE_JULIA_TRIPLE_REGEX, 0, 0), NP2STYLE_Regex, EDITSTYLE_HOLE(L"Regex"), L"fore:#006633; back:#FFF1A8" },
	{ SCE_JULIA_NUMBER, NP2STYLE_Number, EDITSTYLE_HOLE(L"Number"), L"fore:#FF0000" },
	{ SCE_JULIA_VARIABLE, NP2STYLE_Variable, EDITSTYLE_HOLE(L"Variable"), L"fore:#9E4D2A" },
	{ SCE_JULIA_SYMBOL, NP2STYLE_Symbol, EDITSTYLE_HOLE(L"Symbol"), L"fore:#7C5AF3" },
	{ MULTI_STYLE(SCE_JULIA_OPERATOR, SCE_JULIA_OPERATOR2, 0, 0), NP2STYLE_Operator, EDITSTYLE_HOLE(L"Operator"), L"fore:#B000B0" },
};
