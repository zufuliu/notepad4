...
EDITLEXER lexPerl = { SCLEX_PERL, NP2LEX_PERL, L"Perl Script", L"pl; pm; cgi; pod; plx; stp", L"", &Keywords_Perl,
{
	...
	{ SCE_PL_BACKTICKS, 63407, L"Back ticks", L"fore:#E24000; back:#FFF1A8", L"" },
	...
	{ SCE_PL_HERE_QX, 63411, L"Here-doc (back ticks, qx)", L"fore:#E24000; back:#FFF1A8", L"" },
	...
	{ SCE_PL_STRING_QX, 63414, L"Back ticks (qx)", L"fore:#E24000; back:#FFF1A8", L"" },
