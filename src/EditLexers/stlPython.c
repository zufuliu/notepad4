...
static EDITSTYLE Styles_Python[] = {
	...
	{ SCE_PY_BUILTIN_CONST, NP2StyleX_BuiltInConstant, L"bold; fore:#008080" },
	{ SCE_PY_BUILTIN_FUNC, NP2StyleX_BuiltInFunction, L"fore:#0080C0" },
...
EDITLEXER lexPython = {
	...
	L"py; pyw; pyx; pxd; pxi; pyi; py3; pth; boo; empy; cobra; gs",
	&Keywords_Python,
	Styles_Python
};
