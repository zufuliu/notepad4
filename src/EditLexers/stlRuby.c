...
"ARGF ARGV BEGIN DATA END ENV FALSE NIL RUBY_PLATFORM RUBY_RELEASE_DATE RUBY_VERSION STDERR STDIN STDOUT "
"TOPLEVEL_BINDING TRUE __ENCODING__ __FILE__ __LINE__ alias and begin break case class def defined? do "
"else elsif end ensure false for if in include module next nil not or private protected public "
"raise redo refine require rescue retry return self super then true undef unless until when while yield "
