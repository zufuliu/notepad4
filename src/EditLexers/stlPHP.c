...
"exchangeArray( exec( execute( exp( explode( expm1( export( extension_loaded( extract( "
...
"ini_alter( ini_get( ini_get_all( ini_restore( ini_set( insert( intdiv( interface_exists( intval( invoke( invokeArgs( "
"ip2long( isAbstract( isAnonymous( isBacked( isBuiltin( isCloneable( isClosure( isConstructor( isCorrupted( "
...
"memory_get_peak_usage( memory_get_usage( metaphone( method_exists( microtime( min( mkdir( mktime( "
"modify( more_results( move_uploaded_file( mt_getrandmax( mt_rand( mt_srand( multi_query( "
...
static EDITSTYLE Styles_PHP[] = {
	...
	{ SCE_PHP_ESCAPE_CHAR, NP2StyleX_EscapeSequence, L"fore:#0080C0" },
