...
static EDITSTYLE Styles_PHP[] = {
	...
	{ SCE_C_WORD2, 63361, EDITSTYLE_HOLE(L"Magic Method"), L"fore:#0080C0" },
	{ SCE_C_ATTRIBUTE, 63362, EDITSTYLE_HOLE(L"Magic Constant"), L"fore:#FF8000" },
	...
	{ SCE_C_HEREDOC, 63364, EDITSTYLE_HOLE(L"Heredoc String"), L"fore:#648000" },
	{ SCE_C_NOWDOC, 63365, EDITSTYLE_HOLE(L"Nowdoc String"), L"fore:#A46000" },
