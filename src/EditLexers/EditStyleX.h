...
#include "EditStyle.h"
// NP2StyleX_
#define EDITSTYLE_HOLE(style, name)		NP2STYLE_ ## style, CSTRLEN(name), (name)
#define EDITSTYLE_HOLEX(style, name)	style, CSTRLEN(name), (name)
...
#define EDITLEXER_HOLE(name, keywords, styles)	COUNTOF(keywords), StyleTheme_Default, false, true, 0, COUNTOF(styles), CSTRLEN(name), (name), nullptr, nullptr
#define EDITLEXER_TEXT(name, keywords, styles)	COUNTOF(keywords), StyleTheme_Default, false, false, 0, COUNTOF(styles), CSTRLEN(name), (name), nullptr, nullptr
