...
#define EDITLEXER_HOLE(name, keywords, styles)	COUNTOF(keywords), StyleTheme_Light, false, true, 0, COUNTOF(styles), CSTRLEN(name), (name), nullptr, nullptr
#define EDITLEXER_TEXT(name, keywords, styles)	COUNTOF(keywords), StyleTheme_Light, false, false, 0, COUNTOF(styles), CSTRLEN(name), (name), nullptr, nullptr
