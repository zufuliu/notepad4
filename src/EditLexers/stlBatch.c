...
"break call cls cmdextversion defined disabledelayedexpansion disableextensions do "
"echo echo. else enabledelayedexpansion enableextensions endlocal equ errorlevel exist exit for geq goto gtr if in "
"leq lss neq not nul pause popd rem set setlocal shift title ver verify "
