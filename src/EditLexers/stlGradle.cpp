...
static const char * const Keywords_Gradle[] = {
//++Autogenerated -- start of section automatically generated
"abstract as assert break case catch class const continue def default delegate do else enum extends "
...
"beforeEvaluate beforeProject buildCache buildFile buildFinished buildscript buildscript^{} "
"caseSensitive childProjects classpath "
"compileClasspath compiledBy configurations configurations^{} configure container copy copySpec "
"defaultTasks delete dependencies dependencies^{} dependencyLocking dependsOn "
"description destinationDir destinationDirectory destroyables didWork dirPermissions distributions^{} "
"doFirst doLast doNotTrackState duplicatesStrategy "
"eachFile enabled evaluationDependsOn exclude excludes exec expand extensions "
"file filePermissions fileTree files filesMatching filesNotMatching filter finalizedBy findProject findProperty from "
...
"java javaCompiler java^{} javaexec layout localState logger logging manifest mkdir mustRunAfter name normalization "
...
"tarTree targetCompatibility task taskDependencies taskGraph tasks temporaryDir timeout uri useLogger usesService "
"version with zipTree "
...
//Settings++Autogenerated -- start of section automatically generated
		...
		| KeywordAttr64(10, KeywordAttr_NoLexer) // Code Snippet
		, SCE_GROOVY_TASKMARKER,
		SCE_GROOVY_STRING_DQ, SCE_GROOVY_ESCAPECHAR,
//Settings--Autogenerated -- end of section automatically generated
	EDITLEXER_HOLE(L"Gradle Build Script", Keywords_Gradle, Styles_Gradle),
	L"gradle",
	Keywords_Gradle,
	Styles_Gradle
};
