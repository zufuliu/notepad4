...
static EDITSTYLE Styles_TOML[] = {
	...
	{ MULTI_STYLE(SCE_TOML_STRING1, SCE_TOML_STRING2, 0, 0), NP2StyleX_String, L"fore:#008000" },
	{ MULTI_STYLE(SCE_TOML_TRIPLE_STRING1, SCE_TOML_TRIPLE_STRING2, 0, 0), NP2StyleX_TripleQuotedString, L"fore:#F08000" },
