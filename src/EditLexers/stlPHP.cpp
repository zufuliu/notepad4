...
static const char * const Keywords_PHP[] = {
...
, // 1 type
"array bool callable enum float int iterable mixed never numeric object parent resource self string void "
...
"CachingIterator CallbackFilterIterator ClosedGeneratorException Closure CompileError "
"CURLFile CurlHandle CurlMultiHandle CurlShareHandle CurlSharePersistentHandle CURLStringFile "
...
"ReflectionType ReflectionUnionType ReflectionZendExtension RegexIterator RequestParseBodyException RuntimeException "
"SensitiveParameterValue SessionHandler SimpleXMLElement SimpleXMLIterator SplDoublyLinkedList "
"SplFileInfo SplFileObject SplFixedArray SplHeap SplMaxHeap SplMinHeap SplObjectStorage SplPriorityQueue SplQueue "
"SplStack SplTempFileObject SQLite3 SQLite3Result SQLite3Stmt stdClass "
...
"GLOBALS _COOKIE _ENV _FILES _GET _POST _REQUEST _SERVER _SESSION argc argv this "
...
"ASIA ATLANTIC ATOM ATTR_AUTOCOMMIT ATTR_CASE ATTR_CLIENT_VERSION ATTR_CONNECTION_STATUS ATTR_CURSOR ATTR_CURSOR_NAME "
...
"FETCH_UNIQUE FILE_APPEND FILE_IGNORE_NEW_LINES FILE_NO_DEFAULT_CONTEXT FILE_SKIP_EMPTY_LINES FILE_USE_INCLUDE_PATH "
"FNM_CASEFOLD FNM_NOESCAPE FNM_PATHNAME FNM_PERIOD FOLLOW_SYMLINKS FULL_CACHE "
...
"MYSQLI_READ_DEFAULT_FILE MYSQLI_READ_DEFAULT_GROUP "
...
"PARAM_NULL PARAM_STMT PARAM_STR PARAM_STR_CHAR PARAM_STR_NATL PASSWORD_BCRYPT PASSWORD_DEFAULT "
"PATHINFO_BASENAME PATHINFO_DIRNAME PATHINFO_EXTENSION PATHINFO_FILENAME PATH_SEPARATOR PCRE_VERSION "
...
"PHP_VERSION PHP_VERSION_ID PHP_ZTS "
...
"SCANDIR_SORT_ASCENDING SCANDIR_SORT_DESCENDING SCANDIR_SORT_NONE SEEK_CUR SEEK_END SEEK_SET SELF_FIRST "
...
"SQLITE3_OPEN_CREATE SQLITE3_OPEN_READONLY SQLITE3_OPEN_READWRITE SQLITE3_TEXT STD_PROP_LIST "
...
"array_fill( array_fill_keys( array_filter( array_find( array_find_key( array_first( array_flip( "
"array_intersect( array_intersect_assoc( array_intersect_key( array_intersect_uassoc( array_intersect_ukey( "
"array_is_list( array_key_exists( array_key_first( array_key_last( array_keys( array_last( "
...
"array_walk( array_walk_recursive( arsort( asXML( asin( asinh( asort( assert( "
...
"columnCount( columnName( columnType( commit( compact( compare( "
"connect( connection_aborted( connection_status( constant( containsIterator( convert_uudecode( convert_uuencode( copy( "
"cos( cosh( count( countIterators( count_chars( crc32( create( createAggregate( createCollation( "
"createFromDateString( createFromFormat( createFromImmutable( createFromInterface( createFromMutable( createFunction( "
"create_sid( crypt( curl_copy_handle( curl_errno( curl_error( curl_escape( curl_exec( curl_file_create( curl_getinfo( "
"curl_init( curl_multi_add_handle( curl_multi_close( curl_multi_errno( curl_multi_exec( "
"curl_multi_get_handles( curl_multi_getcontent( curl_multi_info_read( curl_multi_init( curl_multi_remove_handle( "
"curl_multi_select( curl_multi_setopt( curl_multi_strerror( curl_pause( curl_reset( curl_setopt( curl_setopt_array( "
"curl_share_errno( curl_share_init( curl_share_init_persistent( curl_share_setopt( curl_share_strerror( curl_strerror( "
"curl_unescape( curl_upkeep( curl_version( current( "
...
"echo( end( endChildren( endIteration( enqueue( enum_exists( eof( "
"errorCode( errorInfo( error_clear_last( error_get_last( error_log( error_reporting( "
"escapeString( escapeshellarg( escapeshellcmd( "
"exchangeArray( exec( execute( execute_query( exp( explode( expm1( extension_loaded( extract( "
...
"fpassthru( fpm_get_status( fpow( fprintf( fputcsv( fputs( "
...
"get_error_handler( get_exception_handler( get_extension_funcs( get_headers( get_html_translation_table( "
"get_include_path( get_included_files( get_loaded_extensions( get_mangled_object_vars( get_meta_tags( get_object_vars( "
"get_parent_class( get_required_files( get_resource_id( get_resource_type( get_resources( get_result( get_server_info( "
"get_warnings( getcwd( getdate( getenv( gethostbyaddr( gethostbyname( gethostbynamel( gethostname( getlastmod( "
...
"key( key_exists( krsort( ksort( "
"lastErrorCode( lastErrorMsg( lastInsertId( lastInsertRowID( lcfirst( lchgrp( lchown( levenshtein( "
...
"phpinfo( phpversion( pi( poll( pop( popen( pos( pow( preg_filter( preg_grep( preg_last_error( preg_last_error_msg( "
"preg_match( preg_match_all( preg_quote( preg_replace( preg_replace_callback( preg_replace_callback_array( preg_split( "
"prepare( prev( print( print_r( printf( "
...
"recoverFromCorruption( registerXPathNamespace( register_shutdown_function( register_tick_function( release_savepoint( "
"removeAll( removeAllExcept( rename( request_parse_body( "
...
"session_write_close( setAttribute( setAuthorizer( setCsvControl( setDate( setExtractFlags( "
...
"socket_get_status( socket_set_blocking( sort( soundex( spl_autoload( "
...
"stream_copy_to_stream( stream_eof( "
...
, // 9 misc
"AUTH_TYPE AllowDynamicProperties Attribute DOCUMENT_ROOT DelayedTargetValidation Deprecated GATEWAY_INTERFACE "
"HTTPS HTTP_ACCEPT HTTP_ACCEPT_CHARSET HTTP_ACCEPT_ENCODING HTTP_ACCEPT_LANGUAGE HTTP_CONNECTION HTTP_HOST HTTP_REFERER "
"HTTP_USER_AGENT "
"NoDiscard ORIG_PATH_INFO Override PATH_INFO PATH_TRANSLATED PHP_AUTH_DIGEST PHP_AUTH_PW PHP_AUTH_USER PHP_SELF "
"QUERY_STRING "
...
//Settings++Autogenerated -- start of section automatically generated
		...
		| KeywordAttr64(13, KeywordAttr_NoLexer) // Code Snippet
		, 0,
		SCE_PHP_ESCAPECHAR, SCE_PHP_NOWDOC_ID,
//Settings--Autogenerated -- end of section automatically generated
	EDITLEXER_HOLE(L"PHP Script", Keywords_PHP, Styles_PHP),
