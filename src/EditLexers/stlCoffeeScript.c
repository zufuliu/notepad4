...
static EDITSTYLE Styles_CoffeeScript[] = {
	...
	{ MULTI_STYLE(SCE_COFFEESCRIPT_REGEX, SCE_COFFEESCRIPT_TRIPLE_REGEX, 0, 0), NP2StyleX_Regex, L"fore:#006633; back:#FFF1A8" },
...
//Settings++Autogenerated -- start of section automatically generated
	{
		LexerAttr_IndentBasedFolding | LexerAttr_IndentLookForward,
