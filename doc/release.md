The builds (*unsigned*) works for Windows XP (or Windows Server 2003) and above. The AVX2 build works for 64-bit Windows 7 (or Windows Server 2008 R2) and above.
