...
curl -fsSL -o "LLVM-13.0.0-rc4-win64.exe" "https://github.com/llvm/llvm-project/releases/download/llvmorg-13.0.0-rc4/LLVM-13.0.0-rc4-win64.exe"
"LLVM-13.0.0-rc4-win64.exe" /S
