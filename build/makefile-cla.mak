...
INCLUDEDIRS   = /I "$(SCI_INC)" /I "$(SCI_LEX)" /I "$(SCI_LIB)" /I "$(SCI_SRC)" \
                /I "$(SCI_WIN)" /I "$(NP2_SRC)"
CXXFLAGS      = /nologo /c --analyze -Wall -Wextra -Wno-deprecated-declarations -Wno-missing-braces -Wno-unused-parameter -Wno-missing-field-initializers \
