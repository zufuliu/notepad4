...
IF /I "%~1" == "llvm" (
  ...
  curl -fsSL -o "llvm-mingw-20250319-ucrt-x86_64.zip" "https://github.com/mstorsjo/llvm-mingw/releases/download/20250319/llvm-mingw-20250319-ucrt-x86_64.zip"
  7z x -y -o"C:\" "llvm-mingw-20250319-ucrt-x86_64.zip" >NUL
  move /Y "C:\llvm-mingw-20250319-ucrt-x86_64" "C:\llvm-mingw"
)
