...
IF /I "%~1" == "ucrt" (
  ...
  curl -fsSL -o "llvm-mingw-20260505-ucrt-x86_64.zip" "https://github.com/mstorsjo/llvm-mingw/releases/download/20260505/llvm-mingw-20260505-ucrt-x86_64.zip"
  7z x -y -o"C:\" "llvm-mingw-20260505-ucrt-x86_64.zip" >NUL
  move /Y "C:\llvm-mingw-20260505-ucrt-x86_64" "C:\llvm-mingw"
)
