...
:COPY_x64_AVX512
XCOPY /Q /S /Y "..\build\bin\%1\x64\locale" "..\build\bin\%1\AVX512\locale\"
EXIT /B
...
TITLE %~nx0 %1
ECHO. & ECHO.
ECHO Usage: %~nx0 [Clean^|Build^|Rebuild] [Win32^|x64^|AVX2^|AVX512^|ARM64^|all^|No32bit] [Debug^|Release^|all]
ECHO.
