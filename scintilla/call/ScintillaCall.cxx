...
int ScintillaCall::CharacterAndWidth(Position pos, Position width) {
...
void ScintillaCall::CopyStyles(int sourceIndex, int destStyles) {
	Call(Message::CopyStyles, sourceIndex, destStyles);
}
...
void ScintillaCall::SetEOLSelectedWidth(int percent) {
	Call(Message::SetEOLSelectedWidth, percent);
}
...
void ScintillaCall::SetCharClassesEx(int length, const char *characters) {
	CallString(Message::SetCharClassesEx, length, characters);
}
...
void ScintillaCall::Cut(bool asBinary) {
	Call(Message::Cut, asBinary);
}

void ScintillaCall::Copy(bool asBinary) {
	Call(Message::Copy, asBinary);
}

void ScintillaCall::Paste(bool asBinary) {
	Call(Message::Paste, asBinary);
}
...
void ScintillaCall::ShowNotification(int notifyPos, const char *definition) {
	CallString(Message::ShowNotification, notifyPos, definition);
}
...
void ScintillaCall::SetEndAtLastLine(int endAtLastLine) {
	Call(Message::SetEndAtLastLine, endAtLastLine);
}

int ScintillaCall::EndAtLastLine() {
	return static_cast<int>(Call(Message::GetEndAtLastLine));
}
...
void ScintillaCall::Tab(int what) {
	Call(Message::Tab, what);
}
...
void ScintillaCall::LineCut(bool lineCopy) {
	Call(Message::LineCut, lineCopy);
}
...
void ScintillaCall::LineCopy(bool lineCopy) {
	Call(Message::LineCopy, lineCopy);
}
