...
def buildLineBreakOpportunity():
	...
	notBreak = {
	'AI': 'AI AL BA BK CJ CL CM CP CR EX GL HH HL HY IN IS LF NL NS NU PO PR QU SA SP SY WJ XX ZW ZWJ',
	'AK': 'BA BK CJ CL CM CP CR EX GL HH HY IN IS LF NL NS QU SP SY VF VI WJ ZW ZWJ',
	'AL': 'AI AL BA BK CJ CL CM CP CR EX GL HH HL HY IN IS LF NL NS NU PO PR QU SA SP SY VI WJ XX ZW ZWJ',
	'AP': 'AK AS BA BK CJ CL CM CP CR EX GL HH HY IN IS LF NL NS QU SP SY WJ ZW ZWJ',
	'AS': 'BA BK CJ CL CM CP CR EX GL HH HY IN IS LF NL NS QU SP SY VF VI WJ ZW ZWJ',
	'B2': 'B2 BA BK CJ CL CM CP CR EX GL HH HY IN IS LF NL NS QU SP SY WJ ZW ZWJ',
	'BA': 'BA BK CJ CL CM CP CR EX HH HY IN IS LF NL NS QU SP SY WJ ZW ZWJ',
	'BB': 'AI AK AL AP AS B2 BA BB BK CJ CL CM CP CR EB EM EX GL H2 H3 HH HL HY ID IN IS JL JT JV LF NL NS NU OP PO PR QU RI SA SP SY VF VI WJ XX ZW ZWJ',
	'CB': 'BK CL CM CP CR EX GL IS LF NL QU SP SY WJ ZW ZWJ',
	'CJ': 'BA BK CJ CL CM CP CR EX GL HH HY IN IS LF NL NS QU SP SY WJ ZW ZWJ',
	'CL': 'BA BK CJ CL CM CP CR EX GL HH HY IN IS LF NL NS QU SP SY WJ ZW ZWJ',
	'CM': 'AI AL BA BK CJ CL CM CP CR EX GL HH HL HY IN IS LF NL NS NU PO QU SA SP SY WJ XX ZW ZWJ',
	'CP': 'AI AL BA BK CJ CL CM CP CR EX GL HH HL HY IN IS LF NL NS NU QU SA SP SY WJ XX ZW ZWJ',
	'CR': 'LF',
	'EB': 'BA BK CJ CL CM CP CR EM EX GL HH HY IN IS LF NL NS PO QU SP SY WJ ZW ZWJ',
	'EM': 'BA BK CJ CL CM CP CR EX GL HH HY IN IS LF NL NS PO QU SP SY WJ ZW ZWJ',
	'EX': 'BA BK CJ CL CM CP CR EX GL HH HY IN IS LF NL NS QU SP SY WJ ZW ZWJ',
	'GL': 'AI AK AL AP AS B2 BA BB BK CB CJ CL CM CP CR EB EM EX GL H2 H3 HH HL HY ID IN IS JL JT JV LF NL NS NU OP PO PR QU RI SA SP SY VF VI WJ XX ZW ZWJ',
	'H2': 'BA BK CJ CL CM CP CR EX GL HH HY IN IS JT JV LF NL NS PO QU SP SY WJ ZW ZWJ',
	'H3': 'BA BK CJ CL CM CP CR EX GL HH HY IN IS JT LF NL NS PO QU SP SY WJ ZW ZWJ',
	'HH': 'AI BA BK CJ CL CM CP CR EX HH HY IN IS LF NL NS QU SA SP SY WJ XX ZW ZWJ',
	'HL': 'AI AL BA BK CJ CL CM CP CR EX GL HH HL HY IN IS LF NL NS NU PO PR QU SA SP SY WJ XX ZW ZWJ',
	'HY': 'AI BA BK CJ CL CM CP CR EX HH HY IN IS LF NL NS NU QU SA SP SY WJ XX ZW ZWJ',
	'ID': 'BA BK CJ CL CM CP CR EX GL HH HY IN IS LF NL NS PO QU SP SY WJ ZW ZWJ',
	'IN': 'BA BK CJ CL CM CP CR EX GL HH HY IN IS LF NL NS QU SP SY WJ ZW ZWJ',
	'IS': 'AI AL BA BK CJ CL CM CP CR EX GL HH HL HY IN IS LF NL NS NU QU SA SP SY WJ XX ZW ZWJ',
	'JL': 'BA BK CJ CL CM CP CR EX GL H2 H3 HH HY IN IS JL JV LF NL NS PO QU SP SY WJ ZW ZWJ',
	'JT': 'BA BK CJ CL CM CP CR EX GL HH HY IN IS JT LF NL NS PO QU SP SY WJ ZW ZWJ',
	'JV': 'BA BK CJ CL CM CP CR EX GL HH HY IN IS JT JV LF NL NS PO QU SP SY WJ ZW ZWJ',
	'NS': 'BA BK CJ CL CM CP CR EX GL HH HY IN IS LF NL NS QU SP SY WJ ZW ZWJ',
	'NU': 'AI AL BA BK CJ CL CM CP CR EX GL HH HL HY IN IS LF NL NS NU PO PR QU SA SP SY WJ XX ZW ZWJ',
	'OP': 'AI AK AL AP AS B2 BA BB BK CB CJ CL CM CP CR EB EM EX GL H2 H3 HH HL HY ID IN IS JL JT JV LF NL NS NU OP PO PR QU RI SA SP SY VF VI WJ XX ZW ZWJ',
	'PO': 'AI AL BA BK CJ CL CM CP CR EX GL HH HL HY IN IS LF NL NS NU QU SA SP SY WJ XX ZW ZWJ',
	'PR': 'AI AL BA BK CJ CL CM CP CR EB EM EX GL H2 H3 HH HL HY ID IN IS JL JT JV LF NL NS NU QU SA SP SY WJ XX ZW ZWJ',
	'QU': 'AI AK AL AP AS B2 BA BB BK CB CJ CL CM CP CR EB EM EX GL H2 H3 HH HL HY ID IN IS JL JT JV LF NL NS NU OP PO PR QU RI SA SP SY VF VI WJ XX ZW ZWJ',
	'RI': 'BA BK CJ CL CM CP CR EX GL HH HY IN IS LF NL NS QU RI SP SY WJ ZW ZWJ',
	'SA': 'AI AL BA BK CJ CL CM CP CR EX GL HH HL HY IN IS LF NL NS NU OP PO PR QU SA SP SY WJ XX ZW ZWJ',
	'SP': 'BK CL CP CR EX IS LF NL SP SY WJ ZW',
	'SY': 'BA BK CJ CL CM CP CR EX GL HH HL HY IN IS LF NL NS QU SP SY WJ ZW ZWJ',
	'VF': 'BA BK CJ CL CM CP CR EX GL HH HY IN IS LF NL NS QU SP SY WJ ZW ZWJ',
	'VI': 'AK BA BK CJ CL CM CP CR EX GL HH HY IN IS LF NL NS QU SP SY WJ ZW ZWJ',
	'WJ': 'AI AK AL AP AS B2 BA BB BK CB CJ CL CM CP CR EB EM EX GL H2 H3 HH HL HY ID IN IS JL JT JV LF NL NS NU OP PO PR QU RI SA SP SY VF VI WJ XX ZW ZWJ',
	'XX': 'AI AL BA BK CJ CL CM CP CR EX GL HH HL HY IN IS LF NL NS NU PO PR QU SA SP SY WJ XX ZW ZWJ',
	'ZW': 'BK CR LF NL SP ZW',
	'ZWJ': 'AI AK AL AP AS B2 BA BB BK CB CJ CL CM CP CR EB EM EX GL H2 H3 HH HL HY ID IN IS JL JT JV LF NL NS NU OP PO PR QU RI SA SP SY VF VI WJ XX ZW ZWJ',
	}
