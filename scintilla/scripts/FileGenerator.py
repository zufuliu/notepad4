...
def CopyWithInsertion(original, commentPrefix, retainDefs, lists):
    copying = 1
    generated = False
    listid = 0
    output = []
    for line in original.splitlines(0):
        ...
        if isStartGenerated:
            ...
            if line.startswith(commentPrefix + "**"):
                # Pattern to transform original data
                if retainDefs:
                    output.append(line)
                ...
                # Simple form with no rule to transform original
