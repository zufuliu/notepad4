...
struct FontSpecification {
	...
	explicit constexpr FontSpecification(const char *fontName_ = nullptr, int size_ = 10*Scintilla::FontSizeMultiplier) noexcept :
...
public:
	...
	explicit Style(const char *fontName_ = nullptr) noexcept;
