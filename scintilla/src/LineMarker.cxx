...
void LineMarker::DrawFoldingMark(Surface *surface, PRectangle rcWhole, FoldPart part) const {
...
void LineMarker::Draw(Surface *surface, PRectangle rcWhole, const Font *fontForCharacter, FoldPart part, MarginType marginStyle) const {
	...
	default:
		if (markType >= MarkerSymbol::Character) {
			...
			surface->DrawTextNoClipUTF8(rcText, fontForCharacter, rcText.bottom - 2, character, fore, back);
		} else {
