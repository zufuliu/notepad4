...
public:
	...
	virtual int LineEndTypesSupported() const;
...
public:
	...
	int SCI_METHOD GetLineIndentation(Sci_Position line) const override;
	...
	unsigned char SCI_METHOD StyleAt(Sci_Position position) const override {
