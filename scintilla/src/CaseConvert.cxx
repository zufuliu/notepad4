...
public:
	...
	size_t CaseConvertString(char *converted, size_t sizeConverted, const char *mixed, size_t lenMixed) const override {
...
void CaseConverter::SetupConversions(CaseConversion conversion) {
	...
	auto sComplex = complexCaseConversions.begin();
	constexpr auto end = complexCaseConversions.end();
	while (sComplex != end) {
