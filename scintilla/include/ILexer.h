...
public:
	...
	virtual int SCI_METHOD PropertyType(const char *name) const noexcept = 0;
	virtual const char * SCI_METHOD DescribeProperty(const char *name) const noexcept = 0;
	...
	virtual void * SCI_METHOD PrivateCall(int operation, void *pointer) noexcept = 0;
	virtual int SCI_METHOD LineEndTypesSupported() const noexcept = 0;
	virtual int SCI_METHOD AllocateSubStyles(int styleBase, int numberStyles) noexcept = 0;
	...
	virtual void SCI_METHOD SetIdentifiers(int style, const char *identifiers) noexcept = 0;
