...
public:
	...
	virtual unsigned char SCI_METHOD StyleAt(int position) const = 0;
	...
	virtual void SCI_METHOD StartStyling(int position, unsigned char mask) = 0;
	virtual bool SCI_METHOD SetStyleFor(int length, unsigned char style) = 0;
	virtual bool SCI_METHOD SetStyles(int length, const unsigned char *styles) = 0;
	...
	virtual int SCI_METHOD GetLineIndentation(int line) const = 0;
};
...
public:
	...
	virtual const char * SCI_METHOD PropertyNames() const = 0;
	...
	virtual const char * SCI_METHOD DescribeWordListSets() const = 0;
