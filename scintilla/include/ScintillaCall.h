...
//**\(\*\n\)
	...
	int Margins();
	void StyleClearAll();
	void CopyStyles(int sourceIndex, int destStyles);
	...
	void SetEOLSelectedWidth(int percent);
	...
	void SetCharClassesEx(int length, const char *characters);
	...
	void Undo();
	void Cut(bool asBinary);
	void Copy(bool asBinary);
	void Paste(bool asBinary);
	void Clear();
	...
	void ShowNotification(int notifyPos, const char *definition);
	...
	void SetEndAtLastLine(int endAtLastLine);
	int EndAtLastLine();
