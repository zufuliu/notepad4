...
static void ColouriseCLIDoc(unsigned int startPos, int length, int initStyle, WordList *keywordLists[], Accessor &styler) {
...
static void FoldCLIDoc(unsigned int startPos, int length, int initStyle, WordList *[], Accessor &styler) {
