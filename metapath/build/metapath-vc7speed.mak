...
!IF "$(CFG)" == "i386"
OUTPUT=..\..\bin
CFLAGS=/D "WIN32" /D "_WIN32_WINNT=0x0501" /c /W4 /EHsc /MD /arch:SSE2 /O2 /Oy /Oi /Ot /GT /GL /GF /Gm- /GR- /Gy /GA /Zc:wchar_t /Zc:forScope
RCCFG=/d "_M_IX86"
LDCFG=/VERSION:5.1 /SUBSYSTEM:WINDOWS,5.01 /OSVERSION:5.1 /MACHINE:X86
LIBS2=msvcrt_winxp.obj
!ELSE
OUTPUT=..\..\bin\amd64
CFLAGS=/D "WIN64" /D "_WIN32_WINNT=0x0502" /c /W4 /EHsc /MD /arch:SSE2 /O2 /Oy /Oi /Ot /GT /GL /GF /Gm- /GR- /Gy /GA /Zc:wchar_t /Zc:forScope
RCCFG=/d "_M_AMD64"
...
LDFLAGS=/nologo /INCREMENTAL:NO /RELEASE /OPT:REF /OPT:ICF /LTCG /LARGEADDRESSAWARE /MERGE:.rdata=.text /DEBUG
