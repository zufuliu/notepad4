...
* Syntax highlighting, code folding and API list for (see built-in [file extension list](doc/FileExt.txt)):
	...
	* [C#](tools/lang/CSharp.cs), up to C# 10.0. [Screenshots](https://github.com/zufuliu/notepad2/wiki/Screenshots#c)
	...
	* [Haxe](tools/lang/Haxe.hx), up to Haxe 4.1
	* [HTML](tools/lang/html.html), up to [WHATWG](https://html.spec.whatwg.org/multipage/) 2021-12-21. [Screenshots](https://github.com/zufuliu/notepad2/wiki/Screenshots#html)
		* ASP
		* ASP.NET
		* JSP
		* PHP
	...
	* [Boost Jam](tools/lang/Jamfile.jam), up to Jam 4.4.1.
	...
	* Texinfo
	* TOML File
	* [TypeScript](tools/lang/TypeScript.ts), TypeScript 4.3.
